...
public class Condition3_Activity extends BlunoLibrary implements MessageListener, MediaPlayer.OnCompletionListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle(" TRAINING MODE ROTATION");
